...
insert into supplies(code_supplies, name_supplies, chargingunit, price_supplies) value ('DL1','DenLed','sanpham',600),
...
insert into store(id_supplies, first_quantity, add_quantity, expot_quantity) value (1,200,200,150),
(1,150,200,190),
(2,210,400,170),
(3,20,300,160),
(4,25,230,10),
...
insert into supplier(code_supplier, name_supplier, address_supplier, phone_supplier) value ('HH001','Hoàng Hải','Hải phòng','09923333412'),
...
insert into oder(code_oder, date, id_supplier) value ('cd02','2021-05-15','5'),
('cd04','2021-05-25','4'),
('cd07','2021-04-09','2');
select *
from oder;
...
insert into receipt(code_receipt, date_receipt, id_oder) value ('pn01','2021-04-02','1'),
('pn03','2021-04-02','4'),
('pn05','2021-04-02','3');
select *
from receipt;
...
insert into deliverybill(code_deliverybill, date_delivery, customer_name) value ('bill001','2021-05-14','Híu'),
...
insert into detailoder(id_oder, id_supplies, amount) value (1,1,100),
(2,2,122),
(4,4,50),
(6,5,150);
select *
...
insert into detailreceipt(idd_receipt, idd_supplies, amount, price, note) value (4,2,100,200,''),
(5,2,120,200,''),
(6,1,100,200,''),
(4,3,10,200,''),
(5,4,150,200,''),
...
insert into detaildeliverybill(id_deliverybill, id_supplies, amount, price, note) value (1,2,100,150,''),
(2,5,10,300,''),
(3,1,200,150,''),
(1,4,50,1500,''),
(1,3,40,1500,''),
...
use Managersupplies;
select code_receipt, idd_supplies, amount, price, sum(price * amount)
from receipt
